"""Mahindra SoH-forecaster build pipeline.

Thin wrapper over common.pipeline_factory. Mahindra has no independent yardstick, so the factory builds the
DAG without the acceptance gate (config.mahindra.has_gate is False): preprocess -> train -> evaluate ->
