"""Bajaj preprocessing entry point (Processing step) -> the bajaj_featengg table.

Delegates to common.preprocess_lib; the SoH method (reported BMS SoH (monthly median, non-increasing)) and all params come from the OEM
