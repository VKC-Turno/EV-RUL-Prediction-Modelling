"""Montra SoH-forecaster build pipeline.

Thin wrapper over common.pipeline_factory. Montra has no independent yardstick, so the factory builds the
DAG without the acceptance gate (config.montra.has_gate is False): preprocess -> train -> evaluate ->
