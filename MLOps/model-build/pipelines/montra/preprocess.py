"""Montra preprocessing entry point (Processing step) -> the montra_featengg table.

Delegates to common.preprocess_lib; the SoH method (BMS remaining-capacity (current is unsigned -> no coulomb)) and all params come from the OEM
