"""Piaggio SoH-forecaster build pipeline.

Thin wrapper over common.pipeline_factory. Piaggio has no independent yardstick, so the factory builds the
DAG without the acceptance gate (config.piaggio.has_gate is False): preprocess -> train -> evaluate ->
